...
public class CMain {
	...
	public static void sorteioMorador() {
		...
		opcao = Integer.parseInt(JOptionPane.showInputDialog(null,
				"Há " + moradores.qtde() + " moradores. " + faixa1 + " deles são da faixa 1 e " + faixa2
						+ " deles são da faixa 2. Deseja sortear para qual faixa?",
				"Sorteio", JOptionPane.QUESTION_MESSAGE));
		if (opcao == 1) {
			quantidade = Integer.parseInt(JOptionPane.showInputDialog(null,
					"Quantas casas deseja sortear para " + faixa1 + " moradores da faixa 1?"));
			if (quantidade == 0) {
				JOptionPane.showMessageDialog(null, "Nenhuma casa será sorteada.");
			}
			if (quantidade > faixa1) {
				JOptionPane.showInputDialog(null,
						"O número de casas a serem sorteadas é maior que o número de moradores da faixa 1.\nDeseja sortear casas para todos os moradores?",
			...
			quantidade = Integer.parseInt(JOptionPane.showInputDialog(null,
					"Quantas casas deseja sortear para " + faixa2 + " moradores da faixa 2?"));
			if (quantidade == 0) {
				JOptionPane.showMessageDialog(null, "Nenhuma casa será sorteada.");
			}
